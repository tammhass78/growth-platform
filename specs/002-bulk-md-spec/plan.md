...
Generate a unified specification that aggregates the titles and one‑sentence summaries of every markdown file in the repository, using Node.js and docker‑compose. The tool runs as a CLI with Jest tests and outputs `spec.md` under the feature directory.
...
**Primary Dependencies**: docker-compose, markdown-it
